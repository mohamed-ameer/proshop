...
const ProductScreen = () => {
  ...
  const {data: product,isLoading,refetch,error,} = useGetProductDetailsQuery(productId);//visit: https://redux-toolkit.js.org/rtk-query/usage/queries
                      ...
                      <Row>
                        ...
                        <Col>
                          ...
                          >
                            ...
                            this Array is creating an array with the length of the however many products are in stock.
